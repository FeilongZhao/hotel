        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">1、</label><span class="res-info">环境变量酒店为五星级国际酒店；</span>
                    </li>
                    <li>
                    ...
                    <li>
                        <label class="res-lab">7、</label><span class="res-info">最后再次感谢您对环境变量酒店的支持；</span>
                    </li>
                     <li>
                        <label class="res-lab">8、</label><span class="res-info">本系统最终解释权归环境变量酒店所有。</span>
                    </li>
                </ul>
            </div>
        </div>
